...
def avg_year_for_strategy(
    ...
    """Run a single avg-year strategy."""
...
def apply_strategies_and_format(
    ...
    # resolve_strategies is now just returning deduplicated list, we can just use set or dict.fromkeys directly, 
    # but since we imported from schemas earlier, wait I removed the import! 
    # Let me re-add the import or just do it inline here.
    strategies = list(dict.fromkeys(request.avg_year_strategies))
